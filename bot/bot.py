...
async def error_log(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if host.endswith('/error_log'):
        error = "[USAGE]: Debes indicarme el numero de errores que quieres leer."
        errores=error
    else:
        nums=context.args[0]
        este = "error_log "+ nums
...
async def counter(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    vuelta = (
    f"El porcentaje de uso del comando /info es de {contador_info/contador_global*100:.2f}%\n" +
    f"El porcentaje de uso del comando /host es de {contador_host/contador_global*100:.2f}%\n" +
    f"El porcentaje de uso del comando /ip es de {contador_ip/contador_global*100:.2f}%\n" +
    f"El porcentaje de uso del comando /ping es de {contador_ping/contador_global*100:.2f}%\n" +
    f"El porcentaje de uso del comando /error_log es de {contador_error/contador_global*100:.2f}%\n" +
    f"El porcentaje de uso del comando /service_is_running es de {contador_is_running/contador_global*100:.2f}%\n" +
    f"El porcentaje de uso del comando /service_start es de {contador_start/contador_global*100:.2f}%\n" +
    f"El porcentaje de uso del comando /service_stop es de {contador_stop/contador_global*100:.2f}%\n" +
    f"El porcentaje de uso del comando /ports_in_use es de {contador_ports/contador_global*100:.2f}%\n" +
    f"El porcentaje de uso del comando /mapeado es de {contador_mapeado/contador_global*100:.2f}%\n"
    )
